...
class VisualOdometry():
    ...
    def reprojection_residuals(self, dof, q1, q2, Q1, Q2):
        ...
        t = dof[3:]
        if self.PrintTimes  <10:
           print(f"translation vector {self.PrintTimes+1}: {t}")
        ...
        self.PrintTimes = self.PrintTimes + 1
        return residuals
    ...
    def estimate_pose(self, q1, q2, Q1, Q2, max_iter=120):
        """
        ...
        for _ in range(max_iter):
            ...
            sample_idx = np.random.choice(range(q1.shape[0]), 15)
            #print(sample_idx)
...
def main():
    data_dir = 'KITTI_sequence_4'  # Try KITTI_sequence_2
